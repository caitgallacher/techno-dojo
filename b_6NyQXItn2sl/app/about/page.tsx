    ...
    <main className="min-h-screen bg-obsidian">
      ...
      <section className="pt-48 pb-24 px-4 text-center">
        <div className="max-w-4xl mx-auto space-y-6">
          ...
          <h1 className="font-bebas text-bone text-6xl sm:text-7xl lg:text-8xl leading-none tracking-tight">
            BOTH TECHNO.<br />AND DOJO.
          </h1>
        </div>
      </section>
      ...
      {/* NAME + CREDENTIALS — byline */}
      <section className="py-10 px-4 text-center">
        <div className="max-w-2xl mx-auto space-y-2">
          <p className="font-bebas text-bone text-2xl tracking-widest">CAIT GALLACHER</p>
      ...
      <section className="py-20 px-4">
        <div className="max-w-2xl mx-auto">
          <p className="font-space-mono text-clay text-xs tracking-widest uppercase mb-8">
            WHO I AM
          </p>
          <div className="space-y-5 font-dm-sans font-light text-[#9A9A92] text-lg leading-relaxed">
      ...
      <section className="py-20 px-4">
        <div className="max-w-2xl mx-auto">
          ...
          <div className="space-y-5 font-dm-sans font-light text-[#9A9A92] text-lg leading-relaxed">
            ...
            <p>She gave me a question I have carried with me every day since:</p>
          </div>

          {/* Pull quote */}
          <p className="font-playfair text-bone text-2xl sm:text-3xl italic leading-relaxed my-10">
            &ldquo;Who am I becoming, and am I living in alignment with that person?&rdquo;
          </p>
