...
export default function AboutPage() {
  return (
    <main className="min-h-screen bg-obsidian">
      ...
      {/* PHOTO + WHO I AM — two column, text wraps full width after photo */}
      <section className="bg-obsidian pb-0 px-4 overflow-hidden">
        <div className="max-w-4xl mx-auto">
          <div className="md:flex md:gap-10">

            {/* LEFT: Photo + caption — fixed width, doesn't grow */}
            ...
            {/* RIGHT: WHO I AM text alongside photo */}
            <div className="flex-1 space-y-4">
              <p className="font-space-mono text-clay text-xs tracking-widest uppercase mb-6">
                WHO I AM
              </p>
              <div className="space-y-4 font-dm-sans font-light text-[#9A9A92] text-base leading-relaxed">
      ...
      {/* REMAINING SECTIONS — full width, recentred */}
      ...
      {/* PHOTO + CREDENTIALS + WHO I AM — all inline */}
      <section className="bg-obsidian pb-16 px-4">
        <div className="max-w-4xl mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
            ...
            {/* RIGHT: Credentials + WHO I AM */}
            <div className="md:col-span-2 space-y-6">
              <p className="font-dm-sans text-[#9A9A92] text-sm leading-relaxed font-light italic">
                Former management consultant and entrepreneur. MBA. National athlete, Team Canada All-Star Cheerleading. 200-hour yoga teacher training. 100-hour breathwork and meditation certification. Full-time traveller.
              </p>
      ...
      <section className="bg-obsidian py-16 px-4">
        <div className="max-w-4xl mx-auto">
          <div className="md:ml-[calc(33.333%+2.5rem)]">
            <p className="font-space-mono text-clay text-xs tracking-widest uppercase mb-6">
              THE TURNING POINT
            </p>
            <div className="space-y-4 font-dm-sans font-light text-[#9A9A92] text-base leading-relaxed">
