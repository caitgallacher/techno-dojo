    ...
    <main className="min-h-screen bg-obsidian">
      ...
      <section className="min-h-screen pt-40 flex flex-col items-center justify-center px-4 text-center">
        <div className="space-y-6 max-w-3xl">
          ...
          <p className="font-dm-sans text-[#9A9A92] text-lg leading-relaxed font-light italic">
      ...
      {/* PHOTO */}
      <section className="bg-obsidian py-0 px-4">
      ...
      <section className="bg-obsidian py-32 px-4">
        <div className="max-w-3xl mx-auto">
          <p className="font-space-mono text-clay text-xs tracking-widest uppercase mb-12">
            WHO I AM
          </p>
          <div className="space-y-6 font-dm-sans font-light text-[#9A9A92] text-lg leading-relaxed">
