...
const days = [
  ...
  { day: 2, phase: 'CONTROL', pattern: '4-0-5-0', duration: '8:23',
    spotify: SPOTIFY_SHOW, youtube: 'https://youtu.be/4ypz4ANJ-08', patreon: PATREON_GENERAL },
  { day: 3, phase: 'CONTROL', pattern: '4-0-5-0', duration: '9:11',
    spotify: SPOTIFY_SHOW, youtube: 'https://youtu.be/O0WPbmNkSFs', patreon: PATREON_GENERAL },
  { day: 4, phase: 'CONTROL', pattern: '4-0-6-0', duration: '8:25',
    spotify: SPOTIFY_SHOW, youtube: 'https://youtu.be/pCFkOqgY1gk', patreon: PATREON_GENERAL },
  { day: 5, phase: 'CONTROL', pattern: '4-0-6-0', duration: '8:15',
    spotify: SPOTIFY_SHOW, youtube: 'https://youtu.be/0EhFH0qrz0E', patreon: PATREON_GENERAL },
  { day: 6, phase: 'CONTROL', pattern: '4-1-6-0', duration: '9:21',
    spotify: SPOTIFY_SHOW, youtube: 'https://youtu.be/cpv5pRYxqKM', patreon: PATREON_GENERAL },
  { day: 7, phase: 'CONTROL', pattern: '4-1-6-0', duration: '9:06',
    spotify: SPOTIFY_SHOW, youtube: 'https://youtu.be/Lb0K-2zuIWo', patreon: PATREON_GENERAL },
  { day: 8, phase: 'CONTROL', pattern: '4-2-6-0', duration: '7:39',
    spotify: SPOTIFY_SHOW, youtube: 'https://youtu.be/annhNGIX12Q', patreon: PATREON_GENERAL },
  { day: 9, phase: 'CONTROL', pattern: '4-2-6-0', duration: '7:19',
    spotify: SPOTIFY_SHOW, youtube: 'https://youtu.be/3xEsBXhWaM8', patreon: PATREON_GENERAL },
  { day: 10, phase: 'CONTROL', pattern: '4-2-6-1', duration: '7:55',
    spotify: SPOTIFY_SHOW, youtube: 'https://youtu.be/hHTQg88SJ88', patreon: PATREON_GENERAL },
  { day: 11, phase: 'CAPACITY', pattern: '4-2-6-2', duration: '8:31',
    spotify: SPOTIFY_SHOW, youtube: 'https://youtu.be/V76cvztkvUw', patreon: PATREON_GENERAL },
  { day: 12, phase: 'CAPACITY', pattern: '4-2-6-2', duration: '7:59',
    spotify: SPOTIFY_SHOW, youtube: 'https://youtu.be/YU2a-NMxQtQ', patreon: PATREON_GENERAL },
  { day: 13, phase: 'CAPACITY', pattern: '4-2-6-2', duration: '8:27',
    spotify: SPOTIFY_SHOW, youtube: 'https://youtu.be/Y8InKf8-HYA', patreon: PATREON_GENERAL },
  { day: 14, phase: 'CAPACITY', pattern: '5-3-7-3', duration: '8:19',
    spotify: SPOTIFY_SHOW, youtube: 'https://youtu.be/q7WbzyPYhqk', patreon: PATREON_GENERAL },
  { day: 15, phase: 'CAPACITY', pattern: '5-3-7-3', duration: '8:29',
    spotify: SPOTIFY_SHOW, youtube: 'https://youtu.be/g5-kaN26Wu8', patreon: PATREON_GENERAL },
  { day: 16, phase: 'CAPACITY', pattern: '5-4-7-4', duration: '8:45',
    spotify: SPOTIFY_SHOW, youtube: 'https://youtu.be/-4aDhGuhPPw', patreon: PATREON_GENERAL },
  { day: 17, phase: 'CAPACITY', pattern: '5-4-7-4', duration: '9:00',
    spotify: SPOTIFY_SHOW, youtube: 'https://youtu.be/wGtcR_cgOYM', patreon: PATREON_GENERAL },
  { day: 18, phase: 'CAPACITY', pattern: '5-5-7-5', duration: '8:19',
    spotify: SPOTIFY_SHOW, youtube: 'https://youtu.be/AcKdQFYzZJY', patreon: PATREON_GENERAL },
