...
const PatreonIcon = ({ size = 20 }: { size?: number }) => (
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
          ...
          <div className="flex justify-center gap-6 items-center flex-wrap">
            <a href="https://www.instagram.com/thetechnodojo/" target="_blank" rel="noopener noreferrer"
              className="text-stone hover:text-bone transition-colors duration-300" aria-label="Instagram">
              <Instagram size={20} />
            </a>
            <a href="https://open.spotify.com/show/4Cz6WuByhIpTo1oeaGkIAm?si=a0b1bebb7f854974" target="_blank" rel="noopener noreferrer"
              className="text-stone hover:text-bone transition-colors duration-300" aria-label="Spotify">
              <Music size={20} />
            </a>
            <a href="https://youtube.com/@thetechnodojo?si=qAYMs3M1Kk71LuSt" target="_blank" rel="noopener noreferrer"
              className="text-stone hover:text-bone transition-colors duration-300" aria-label="YouTube">
              <Youtube size={20} />
            </a>
            <a href="https://www.patreon.com/thetechnodojo" target="_blank" rel="noopener noreferrer"
              className="text-stone hover:text-bone transition-colors duration-300" aria-label="Patreon">
              <PatreonIcon size={20} />
            </a>
            <a href="https://www.tiktok.com/@thetechnodojo?is_from_webapp=1&sender_device=pc" target="_blank" rel="noopener noreferrer"
              className="text-stone hover:text-bone transition-colors duration-300" aria-label="TikTok">
            ...
            <a href="https://www.linkedin.com/company/techno-dojo" target="_blank" rel="noopener noreferrer"
              className="text-stone hover:text-bone transition-colors duration-300" aria-label="LinkedIn">
              <Linkedin size={20} />
            </a>
          </div>
          {/* Right: Tagline */}
